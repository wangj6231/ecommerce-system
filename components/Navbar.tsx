                ...
                <div className="pt-4 pb-4 border-t border-gray-200">
                    {session ? (
                        <div className="space-y-1">
                            {session.user.role === 'ADMIN' && (
                                <Link href="/admin" className="block px-4 py-2 text-base font-medium text-indigo-600 hover:text-indigo-800 hover:bg-gray-100">
                                    管理後台
                                </Link>
                            )}
                            <div className="flex items-center px-4">
                                <div className="ml-3">
                                    <div className="text-base font-medium text-gray-800">{session.user.name || session.user.username}</div>
                                </div>
                            </div>
                            <Link href="/profile" className="block mt-3 px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
                                會員資料
                            </Link>
                            <button
                                onClick={() => signOut()}
